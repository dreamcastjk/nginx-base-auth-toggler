...
return [
    ...
    */
    ...
    'options' => [
        ...
        'repository' => 'git@rscz.ru:rocket-station/nginx-base-auth.git',
        'branch' => 'master',
        'shared_dirs' => [
            'storage',
            'vendor',
    ...
    */
    ...
    'hosts' => [
        env('DEPLOY_HOST') => [
            ...
            'stage' => env('DEPLOY_STAGE_NAME'),
            'socket' => env('DEPLOY_SOCKET_PATH'),
        ]
    ],
    ...
    */
    ...
    'include' => [
        'recipe/cache_recipe.php',
        'recipe/cron_recipe.php',
    ],
